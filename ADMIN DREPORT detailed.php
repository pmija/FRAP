...
where latest.Date = date(TXN_DATE) group by m.member_ID";
                                ...
                                <table id="table" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        while($ans = mysqli_fetch_assoc($result)){
                                            $total  =(float)$ans['MFee']+(float)$ans['HFee']+(float)$ans['FFee']+(float)$ans['BFee'];
                                        ...
                                        <td align="center"><b><?php echo sprintf("%.2f",(float)$ans['HFee']);?></b></td>
